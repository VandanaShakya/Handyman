...
export default function Painting() {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    {/* Heading */}
    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#A55018] mb-6 text-center sm:text-left">
      Painting Services
    </h2>

    {/* Paragraph */}
    <p className="text-[#a09e9e] text-base sm:text-lg md:text-xl leading-relaxed max-w-4xl mx-auto sm:mx-0 mb-8 text-center sm:text-left">
      ...
      {paintingImages.map((img, index) => (
        <div key={index} className="overflow-hidden rounded-lg shadow-lg">
          <img
            ...
            loading="lazy"
            className="w-full h-56 sm:h-60 md:h-64 lg:h-72 object-cover transform hover:scale-105 transition-transform duration-300"
          />
        </div>
      ))}
    </div>
