...
import { wallpaperData } from './serviceData'
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-12 md:mb-16">
        ...
        <p className="max-w-3xl mx-auto text-white text-lg">
          From accent walls to full-room wallpaper installation, our handyman wallpaper services ensure flawless results.
          We handle preparation, hanging, trimming, and finishing with precision and care, leaving your space beautiful and unique.
        </p>
      </div>

      {/* Features Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {wallpaperData.map((card) => (
          <div
            key={card.id}
