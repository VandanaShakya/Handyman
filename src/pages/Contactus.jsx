...
const Contactus = () => {
  ...
  {/* Heading */}
  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#A55018] mb-6 text-left lg:text-center">
    Get In Touch
  </h2>

  {/* Paragraph */}
  <p className="text-gray-300 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto text-left lg:text-center">
    Whether you need a quick repair, a full renovation, or expert advice, we’re here to help.
    Reach out to B1 Handyman Experts today — we’ll answer your questions, provide a free estimate,
    and ensure your care home or property gets the attention it deserves. Your comfort and satisfaction are our top priorities.
  </p>

  {/* Contact Info */}
  <div className="mt-8 text-gray-400 text-left lg:text-center text-sm sm:text-base leading-relaxed">
    <div className="flex flex-col sm:flex-row justify-start lg:justify-center items-start sm:items-center gap-6 flex-wrap">
      ...
      <div className="flex items-center gap-2">
        ...
        <a href="tel:+441234567890" className="text-white hover:underline">
          +44 1234 567 890
        </a>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-white">123 Main Street, Bradford, UK</span>
      </div>
    </div>
  </div>
</div>
